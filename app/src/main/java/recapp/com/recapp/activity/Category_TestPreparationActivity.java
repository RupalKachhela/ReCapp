...
public class Category_TestPreparationActivity extends AppCompatActivity implements View.OnClickListener  ,CommunicationHandler.CommunicationHandlerCallBack
{
            ...
            edtBatch.setOnClickListener(new View.OnClickListener()
            {
                public void onClick(View v)
                {
                    ...
                    if (batchNameList != null && !batchNameList.isEmpty()) {
                        new AlertDialog.Builder(Category_TestPreparationActivity.this)
                        ...
                        android.app.AlertDialog alertDialog = new android.app.AlertDialog.Builder(Category_TestPreparationActivity.this).create();
        ...
        switch (v.getId())
        {
            ...
            case R.id.btn_tutionRegister:
            {
                ...
                }else if (edtSchoolName.getText().toString().length() == 0)
                {
                    ...
                    Toast.makeText(this, "Enter Classes name", Toast.LENGTH_SHORT).show();
...
//                    overridePendingTransition(R.anim.slide_in_right, R.anim.anim_hold);
                    ...
                    System.out.println("==== Test Preparation collection data : "+"\n"+rollNo+"\n"+selectedBatchID+"\n"+schoolName+"\n"+country);

                    callForTestPrepationRegister(rollNo , selectedBatchID , schoolName , country);
...
//                    finish();
    ...
    public void callForBatchList()
    {
        ...
        CommunicationHandler.getInstance(this).callForTestPrepBatchList(this,params);
    }

    public void callForTestPrepationRegister(String rollNo , String batchId ,String className , String country)
    {
        HashMap<String, String> params = new HashMap<>();
        ...
        System.out.println("===Test Prep  Register  param : "+params);

        CommunicationHandler.getInstance(this).callForTestPrepationRegister(this , params);
    }

    @Override
    public void successCBWithMethod(String mMethod, JSONObject jsonObject, boolean isSuccess)
    {
        if (mMethod.equals(Const.TEST_PREP_REG)) {

            Logger.putLogInfo("testPrepRegistration ==>", jsonObject.toString());
            ...
            try {
                ...
                if (result == 1) {
                    ...
                    alertDialog.setButton(android.app.AlertDialog.BUTTON_POSITIVE, "Ok", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface aDialogInterface, int aI) {
                            Intent registerIntent = new Intent(Category_TestPreparationActivity.this , LoginActivity.class);
        ...
        if (mMethod.equals(Const.TEST_PREP_BATCH_LIST)) {
...
//                }
                ...
                batchList.addAll(dataList.getTestPrepBatchList());
