...
public class RegisterScreenThreeActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        final ArrayAdapter<String> spinner_breed = new  ArrayAdapter<String>(this,android.R.layout.simple_spinner_dropdown_item, timeList);
        {
            edtTime.setOnClickListener(new View.OnClickListener()
            {
                public void onClick(View v)
                {
                    ...
                    hideInputSoftKey();
                    new AlertDialog.Builder(RegisterScreenThreeActivity.this)
